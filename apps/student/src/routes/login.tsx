  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-bg">
      <aside className="relative hidden lg:flex flex-col justify-between overflow-hidden p-10 text-white bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600">
        <div
          aria-hidden
          className="absolute -top-24 -right-24 h-80 w-80 rounded-full bg-white/20 blur-3xl"
        />
        <div
          aria-hidden
          className="absolute -bottom-32 -left-20 h-96 w-96 rounded-full bg-fuchsia-300/30 blur-3xl"
        />
        ...
        <div className="relative space-y-6 max-w-md">
          <h1 className="text-4xl font-bold leading-tight">
            Belajar lebih terarah, lebih menyenangkan.
          </h1>
          <p className="text-white/80 text-lg">
            Lihat nilai, jadwal, dan absensi kamu dalam satu tempat — kapan saja, di mana saja.
          </p>
          <ul className="space-y-3 text-white/90">
            {[
              "Pantau nilai real-time",
      ...
      <main className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-fg">Masuk ke akunmu</h2>
            <p className="text-sm text-muted-fg">
              Gunakan username atau email dan kata sandi yang diberikan wali kelas.
            </p>
          </div>
          ...
          <p className="text-center text-xs text-muted-fg">
            Lupa kata sandi? Hubungi wali kelas atau admin sekolah.
          </p>
        </div>
      </main>
    </div>

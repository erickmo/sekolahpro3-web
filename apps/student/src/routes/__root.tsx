...
function Layout() {
  ...
  return (
    <RequireAuth roles={["Siswa"]} fallback={<div className="p-6">Loading...</div>}>
      <AppShell
        sidebar={
          <nav className="p-4 space-y-2">
            <Link to="/" className="block px-3 py-2 rounded-md hover:bg-muted">Beranda</Link>
            <Link to="/" className="block px-3 py-2 rounded-md hover:bg-muted">Nilai</Link>
            <Link to="/" className="block px-3 py-2 rounded-md hover:bg-muted">Jadwal</Link>
            <Link to="/" className="block px-3 py-2 rounded-md hover:bg-muted">Absensi</Link>
          </nav>
        }
        topbar={

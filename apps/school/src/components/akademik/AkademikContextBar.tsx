...
import { SearchableSelect, type SearchableOption } from "@sekolahpro/ui";
...
export function AkademikContextBar() {
  const { tahunAjaran, semester, setTahunAjaran, setSemester } = useAkademikContext();
    ...
    <div className="sticky top-0 z-30 -mx-4 sm:-mx-6 lg:-mx-8 mb-4 border-b border-border bg-bg/95 backdrop-blur supports-[backdrop-filter]:bg-bg/75">
      <div className="px-4 sm:px-6 lg:px-8 py-2.5 flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2 min-w-0">
          <label className="text-xs text-muted-fg shrink-0" htmlFor="akademik-ta">
            Tahun Ajaran
          </label>
          <SearchableSelect
            id="akademik-ta"
        ...
        <div className="flex items-center gap-2">
          <label className="text-xs text-muted-fg shrink-0" htmlFor="akademik-semester">
            Semester
          </label>
          <SearchableSelect

...
import { SectionCard, IconAlert, IconChart, IconCheck, IconClock, IconUsers, IconWallet } from "@sekolahpro/ui";
 ...
 * today — closings awaiting approval, pending permohonan, overdue installments,
 * dormant accounts, the onboarding pipeline — each linking to the clearing screen.
 */
    ...
    >
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <WorklistCard
          ...
          hint="Termasuk angsuran jatuh tempo lewat hari ini"

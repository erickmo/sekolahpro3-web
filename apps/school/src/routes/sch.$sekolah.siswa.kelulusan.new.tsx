...
function KelulusanNewPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      void navigate({ to: "/sch/$sekolah/siswa/kelulusan/$id", params: { sekolah, id: doc.name } });
    } catch (e2) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <PageGuide
        ...
        storageId="kelulusan-baru"
        title={SISWA_PAGE_GUIDES["kelulusan-baru"].title}
        intro={SISWA_PAGE_GUIDES["kelulusan-baru"].intro}
        steps={SISWA_PAGE_GUIDES["kelulusan-baru"].steps}
        tips={SISWA_PAGE_GUIDES["kelulusan-baru"].tips}
      ...
      <div className="flex items-center justify-end gap-2">
        <Button type="button" variant="outline" onClick={() => navigate({ to: "/sch/$sekolah/siswa/kelulusan", params: { sekolah } })}>
          Batal
        </Button>
...
export const Route = createFileRoute("/sch/$sekolah/siswa/kelulusan/new")({ component: KelulusanNewPage });

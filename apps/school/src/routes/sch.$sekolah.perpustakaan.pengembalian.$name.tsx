...
export const Route = createFileRoute("/sch/$sekolah/perpustakaan/pengembalian/$name")({
  beforeLoad: async ({ params }) => {
    ...
    throw redirect({ to: "/sch/$sekolah/perpustakaan/peminjaman", params: { sekolah: params.sekolah }, search: { status: "Selesai" } });
  },
});

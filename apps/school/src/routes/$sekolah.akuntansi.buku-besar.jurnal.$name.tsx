...
function JurnalDetailPage() {
  const { sekolah, name } = useParams({ from: "/$sekolah/akuntansi/buku-besar/jurnal/$name" });
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" onClick={() => navigate({ to: "/$sekolah/akuntansi/buku-besar/jurnal", params: { sekolah } })}>← Kembali</Button>
          </div>
        }
      />
...
export const Route = createFileRoute("/$sekolah/akuntansi/buku-besar/jurnal/$name")({

  ...
  return (
    <div className="space-y-3">
      <div className="inline-flex rounded-md border border-border bg-card p-1">
        <Link to="/sch/$sekolah/perpustakaan/peminjaman" params={{ sekolah }}
      ...
      <ResourceListPage<Row>
        ...
        onAdd={() => navigate({ to: "/sch/$sekolah/perpustakaan/kolektif/$name", params: { sekolah, name: "new" } })}
        onRowClick={(r) => navigate({ to: "/sch/$sekolah/perpustakaan/kolektif/$name", params: { sekolah, name: r.name } })}
      />
    </div>
  );
}

export const Route = createFileRoute("/sch/$sekolah/perpustakaan/kolektif")({ component: KolektifListPage });

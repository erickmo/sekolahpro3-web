...
type Row = { name: string; nama: string; nama_gelombang?: string; tahun_ajaran?: string; tanggal_buka?: string; tanggal_tutup?: string; kuota?: number; status?: string };
...
function GelombangPage() {
  return (
    <ResourceListPage<Row>
      ...
      fields={["name", "nama", "tahun_ajaran", "tanggal_buka", "tanggal_tutup", "kuota", "status"]}
      rowKey={(r) => r.name}
      columns={COLUMNS}

...
type Row = { name: string; nama_kurikulum: string; tahun_berlaku?: string; jenjang?: string; status?: string };

const COLUMNS: Column<Row>[] = [
  { key: "name", header: "ID", sortable: true, cell: (r) => <span className="font-mono text-xs">{r.name}</span> },
  { key: "nama_kurikulum", header: "Nama Kurikulum", sortable: true, cell: (r) => r.nama_kurikulum },
...
const FIELDS: FieldSpec[] = [
  { name: "nama_kurikulum", label: "Nama Kurikulum", required: true, colSpan: 2 },
  ...
  return (
    <>
      <ResourceListPage<Row>
        ...
        title="Kurikulum"
        doctype="Kurikulum"
        fields={["name", "nama_kurikulum", "tahun_berlaku", "jenjang", "status"]}
        rowKey={(r) => r.name}
        columns={COLUMNS}
        defaultSort={{ key: "tahun_berlaku", dir: "desc" }}
        searchFields={["name", "nama_kurikulum"]}

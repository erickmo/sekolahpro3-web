...
function MutasiMasukNewPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      void navigate({ to: "/sch/$sekolah/siswa/mutasi-masuk", params: { sekolah } });
    } catch (e) {
      ...
      {step === 1 ? (
        ...
        >
          ...
          <div className="mt-4 flex items-center justify-end gap-2">
            <Button type="button" variant="outline" onClick={() => navigate({ to: "/sch/$sekolah/siswa/mutasi-masuk", params: { sekolah } })}>
              Batal
            </Button>
...
export const Route = createFileRoute("/sch/$sekolah/siswa/mutasi-masuk/new")({ component: MutasiMasukNewPage });

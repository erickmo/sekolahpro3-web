...
function PersetujuanNewPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      void navigate({ to: "/sch/$sekolah/siswa/persetujuan/$id", params: { sekolah, id: doc.name } });
    } catch (e2) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center justify-end gap-2">
        <Button type="button" variant="outline" onClick={() => navigate({ to: "/sch/$sekolah/siswa/persetujuan", params: { sekolah } })}>
          Batal
        </Button>
...
export const Route = createFileRoute("/sch/$sekolah/siswa/persetujuan/new")({ component: PersetujuanNewPage });

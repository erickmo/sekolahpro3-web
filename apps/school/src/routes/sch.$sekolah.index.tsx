...
type FocusItem = {
  label: string;
  href: "/sch/$sekolah/absensi/guru" | "/sch/$sekolah/absensi/pelajaran" | "/sch/$sekolah/jadwal/daftar" | "/sch/$sekolah/jadwal/slot" | "/sch/$sekolah/keuangan" | "/sch/$sekolah/pesan" | "/sch/$sekolah/siswa/daftar" | "/sch/$sekolah/ppdb/pembayaran" | "/kop/$sekolah/kas-teller" | "/sch/$sekolah/laporan";
  meta: string;
};

const FOCUS_BY_MODE: Record<DayMode, readonly FocusItem[]> = {
  pagi: [
    { label: "Cek guru belum input absensi", href: "/sch/$sekolah/absensi/guru", meta: "2 guru" },
    { label: "Tinjau izin siswa masuk", href: "/sch/$sekolah/absensi/pelajaran", meta: "5 izin" },
    { label: "Konfirmasi agenda hari ini", href: "/sch/$sekolah/jadwal/daftar", meta: "12 sesi" },
    { label: "Cari guru pengganti (izin)", href: "/sch/$sekolah/jadwal/slot", meta: "2 kelas" },
  ],
  siang: [
    { label: "Proses pembayaran SPP", href: "/sch/$sekolah/keuangan", meta: "8 transaksi" },
    { label: "Layani permintaan wali", href: "/sch/$sekolah/pesan", meta: "3 pesan baru" },
    { label: "Follow-up berkas siswa", href: "/sch/$sekolah/siswa/daftar", meta: "12 belum lengkap" },
    { label: "Verifikasi pembayaran PPDB", href: "/sch/$sekolah/ppdb/pembayaran", meta: "4 pending" },
  ],
  sore: [
    { label: "Tutup kas teller", href: "/kop/$sekolah/kas-teller", meta: "1 belum closing" },
    { label: "Finalisasi absensi harian", href: "/sch/$sekolah/absensi/pelajaran", meta: "3 kelas" },
    { label: "Rekap pengeluaran", href: "/sch/$sekolah/keuangan", meta: "" },
    { label: "Generate laporan harian", href: "/sch/$sekolah/laporan", meta: "" },
  ],
  "luar-jam": [
    { label: "Lihat ringkasan kemarin", href: "/sch/$sekolah/laporan", meta: "" },
    { label: "Persiapan agenda besok", href: "/sch/$sekolah/jadwal/daftar", meta: "" },
  ],
};
...
const riskRollup: (AttentionItem & {
  actionHref: "/sch/$sekolah/staff/sk-mengajar" | "/sch/$sekolah/jadwal/slot" | "/sch/$sekolah/keuangan" | "/sch/$sekolah/kelas/rombel";
  metaText: string;
})[] = [
  {
    id: "sk-habis",
    ...
    actionHref: "/sch/$sekolah/staff/sk-mengajar",
    metaText: "6 SK",
  },
  {
    id: "guru-absen",
    ...
    actionHref: "/sch/$sekolah/jadwal/slot",
    metaText: "2 guru",
  },
  {
    id: "spp-nunggak",
          ...
          >
            <AttentionList
              ...
              renderLink={(href, children) => (
                ...
                <Link to={href as "/sch/$sekolah/staff/sk-mengajar"} params={{ sekolah }}>{children}</Link>
              )}
            />
          </SectionCard>

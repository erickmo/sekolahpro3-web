...
function PeminjamanPage() {
  ...
  const search = useSearch({ from: "/sch/$sekolah/perpustakaan/peminjaman" }) as Search;
    ...
    <>
        ...
        selectFilters={[
          {
            ...
            onChange: (v) => {
              ...
              navigate({ to: "/sch/$sekolah/perpustakaan/peminjaman", params: { sekolah }, search: next });
            },
          },
        ]}
        addLabel="Pinjam Baru"
        onAdd={() => setCreateOpen(true)}
        onRowClick={(r) => navigate({ to: "/sch/$sekolah/perpustakaan/peminjaman/$name", params: { sekolah, name: r.name } })}
      ...
      <PerpCreateModal
        ...
        onCreated={(doc) => {
          ...
          if (name) navigate({ to: "/sch/$sekolah/perpustakaan/peminjaman/$name", params: { sekolah, name } });
        }}
      />
...
export const Route = createFileRoute("/sch/$sekolah/perpustakaan/peminjaman")({

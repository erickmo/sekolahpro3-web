  ...
  return (
    <>
      <PerpDetailScaffold
        ...
        title={name}
        backTo="/sch/$sekolah/perpustakaan/peminjaman"
        crumbParent={{ label: "Peminjaman", to: "/sch/$sekolah/perpustakaan/peminjaman" }}
        crumbSelf={name}
        ...
        actions={
          <>
            ...
            <Button size="sm" variant="outline" onClick={() => navigate({ to: "/sch/$sekolah/perpustakaan/peminjaman", params: { sekolah } })}>Tutup</Button>
          </>
        }
      />
      <Modal
...
export const Route = createFileRoute("/sch/$sekolah/perpustakaan/peminjaman/$name")({ component: PeminjamanDetailPage });

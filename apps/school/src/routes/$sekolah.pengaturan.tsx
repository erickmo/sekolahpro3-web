...
const TABS: { to: string; label: string; icon: ReactNode; exact?: boolean }[] = [
  { to: "/$sekolah/pengaturan", label: "Umum", icon: <IconSettings />, exact: true },
  { to: "/$sekolah/pengaturan/modul", label: "Modul Aktif", icon: <IconLayers /> },
  { to: "/$sekolah/pengaturan/feature-flag", label: "Feature Flag", icon: <IconFlag /> },
];
...
function PengaturanLayout() {
  ...
  const counts: Record<string, number | undefined> = {
    "/$sekolah/pengaturan/modul": modulOn.data?.length,
    "/$sekolah/pengaturan/feature-flag": flagOn.data?.length,
  };
...
export const Route = createFileRoute("/$sekolah/pengaturan")({ component: PengaturanLayout });

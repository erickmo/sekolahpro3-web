...
function PembayaranDetailPage() {
  const { sekolah, name } = useParams({ from: "/$sekolah/akuntansi/buku-besar/pembayaran/$name" });
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" onClick={() => navigate({ to: "/$sekolah/akuntansi/buku-besar/pembayaran", params: { sekolah } })}>← Kembali</Button>
          </div>
        }
      />
...
export const Route = createFileRoute("/$sekolah/akuntansi/buku-besar/pembayaran/$name")({

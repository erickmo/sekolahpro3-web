      ...
      {gedungQ.isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {gedungList.map((g) => (
            <Link
              key={g.name}
              to="/sch/$sekolah/infrastruktur/daftar-gedung/$gedungId"
...
export const Route = createFileRoute("/sch/$sekolah/infrastruktur/daftar-gedung/")({ component: GedungListPage });

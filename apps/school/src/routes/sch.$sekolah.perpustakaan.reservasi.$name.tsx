...
function ReservasiDetailPage() {
  ...
  return (
    <PerpDetailScaffold
      ...
      title={name}
      backTo="/sch/$sekolah/perpustakaan/reservasi"
      crumbParent={{ label: "Reservasi", to: "/sch/$sekolah/perpustakaan/reservasi" }}
      crumbSelf={name}
      ...
      actions={
        <>
          ...
          <Button size="sm" variant="outline" onClick={() => navigate({ to: "/sch/$sekolah/perpustakaan/reservasi", params: { sekolah } })}>Tutup</Button>
        </>
      }
    />
  );
...
export const Route = createFileRoute("/sch/$sekolah/perpustakaan/reservasi/$name")({ component: ReservasiDetailPage });

...
function BudgetNewPage() {
  ...
  const handleSave = async (submit: boolean) => {
    ...
    try {
      ...
      navigate({ to: "/sch/$sekolah/akuntansi/anggaran/budget/$name", params: { sekolah, name: doc.name } });
    } catch (e) {
...
export const Route = createFileRoute("/sch/$sekolah/akuntansi/anggaran/budget/new")({

  ...
  return (
    <>
      ...
      <ResourceListPage<Row>
        ...
        onAdd={() => setOpen(true)}
        onRowClick={(r) => navigate({ to: "/sch/$sekolah/perpustakaan/anggota/$name", params: { sekolah, name: r.name } })}
      />
      <PerpCreateModal
        open={open}
        ...
        onCreated={(doc) => {
          ...
          if (name) navigate({ to: "/sch/$sekolah/perpustakaan/anggota/$name", params: { sekolah, name } });
        }}
      />
    </>
  );
...
export const Route = createFileRoute("/sch/$sekolah/perpustakaan/anggota")({ component: AnggotaPage });

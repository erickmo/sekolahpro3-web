...
function FeatureFlagDetailPage() {
  ...
  return (
    <MasterDetailPage<Doc>
      ...
      parentPath="/sch/$sekolah/pengaturan/feature-flag"
...
export const Route = createFileRoute("/sch/$sekolah/pengaturan/feature-flag/$name")({ component: FeatureFlagDetailPage });

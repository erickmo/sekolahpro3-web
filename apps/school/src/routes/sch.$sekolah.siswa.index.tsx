...
const SISWA_FLOW_STEPS: ModuleFlowStep[] = [
  ...
  { key: "tambah", label: "Tambah Siswa", hint: "Satuan atau import CSV", href: "/sch/$sekolah/siswa/new" },
...
const QUICK_ACTIONS: {
  ...
  { to: "/sch/$sekolah/siswa/new", label: "Tambah Siswa", description: "Daftarkan siswa baru ke sistem.", icon: <IconPlus /> },
  ...
  { to: "/sch/$sekolah/siswa/wali", label: "Data Wali", description: "Lihat dan perbarui data wali siswa.", icon: <IconUsers /> },
];
  ...
  const attentionItems = useMemo<AttentionItem[]>(() => {
    ...
    if (stats.berkasKurang > 0) {
      items.push({
        ...
        actionHref: "/sch/$sekolah/siswa/daftar",
      });
    }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          accent="amber"
          urgency="warn"
          actionHref="/sch/$sekolah/siswa/mutasi"
          renderLink={(href, children) => <Link to={href}>{children}</Link>}
        />
        <StatCard
      ...
      <ModuleFlow
        ...
        renderLink={(href, children) => (
          <Link to={href as "/sch/$sekolah/siswa/rombel"} params={{ sekolah }}>
            {children}
          </Link>
        )}
      />
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <SectionCard
          ...
          action={
            <Link to="/sch/$sekolah/siswa/daftar" params={{ sekolah }} className="text-xs text-brand hover:underline">
              Lihat semua
            </Link>
          }
        >

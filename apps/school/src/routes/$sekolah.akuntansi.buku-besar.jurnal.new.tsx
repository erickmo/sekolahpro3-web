...
function JurnalNewPage() {
  ...
  const handleSave = async (submit: boolean) => {
    ...
    try {
      ...
      navigate({ to: "/$sekolah/akuntansi/buku-besar/jurnal/$name", params: { sekolah, name: doc.name } });
    } catch (e) {
...
export const Route = createFileRoute("/$sekolah/akuntansi/buku-besar/jurnal/new")({

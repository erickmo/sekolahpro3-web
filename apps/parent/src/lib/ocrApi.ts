// ocrApi — parent-app HTTP client for the backend ID-OCR endpoint (authenticated).
//
...
// Mirrors apps/school/src/lib/ocrApi.ts — same endpoint, same wire format.
 ...
 * @param sekolah  - Optional sekolah doc name for scoping (omit for parent-app context).
